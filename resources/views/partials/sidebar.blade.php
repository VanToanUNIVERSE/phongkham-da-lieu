    ...
    <aside class="w-64 bg-slate-900 border-r border-slate-800 text-slate-300 flex-shrink-0 flex flex-col items-center">
        ...
        <nav class="flex-1 px-4 space-y-2 w-full">
            <a href="{{ url('/reception/dashboard') }}" 
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->is('reception/dashboard') ? 'bg-blue-600 text-white shadow-lg' : 'hover:bg-slate-800 hover:text-white' }}">
