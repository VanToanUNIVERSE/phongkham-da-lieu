                    ...
                    @foreach ($users as $user)
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="py-3 px-6 flex items-center gap-3">
                                <div class="h-10 w-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-base shadow-sm border border-blue-200 overflow-hidden">
                                    @if($user->avatar)
